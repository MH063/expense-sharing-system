<template>
  <div class="leave-records-management">
    ...
    >
      <div v-if="currentRecord" class="record-detail">
        ...
        <div class="detail-item">
          ...
          <span class="value">{{ getLeaveTypeText(currentRecord.type) }}</span>
        </div>
        <div class="detail-item">
    ...
    <el-dialog
      ...
      width="600px"
    >
      <div v-if="leaveStats" class="stats-content">
        <el-row :gutter="20">
          <el-col :span="12">
            <el-card class="stat-card">
              <div class="stat-item">
                <div class="stat-label">总记录数</div>
                <div class="stat-value">{{ leaveStats.total_records }}</div>
              </div>
            </el-card>
          </el-col>
          <el-col :span="12">
            <el-card class="stat-card">
              <div class="stat-item">
                ...
                <div class="stat-value">{{ leaveStats.pending_count }}</div>
              </div>
            </el-card>
          </el-col>
        </el-row>
          ...
          <el-col :span="12">
            <el-card class="stat-card">
              <div class="stat-item">
                ...
                <div class="stat-value">{{ leaveStats.approved_count }}</div>
              </div>
            </el-card>
          </el-col>
          <el-col :span="12">
            <el-card class="stat-card">
              <div class="stat-item">
                ...
                <div class="stat-value">{{ leaveStats.rejected_count }}</div>
              </div>
            </el-card>
          </el-col>
        </el-row>
        ...
        <div class="type-stats" style="margin-top: 20px;">
          <h3>按类型统计</h3>
          <el-table :data="leaveStats.type_stats" style="width: 100%">
...
const leaveTypes = computed(() => {
  return leaveRecordsStore.leaveTypes || []
})
...
const editRecord = (record) => {
  ...
  leaveRecordForm.type = record.type
...
const fetchLeaveStats = async () => {
  ...
  try {
    ...
    const stats = await leaveRecordsStore.fetchLeaveStats({
    ...
    ElMessage.error('获取请假统计失败: ' + error.message)
  }
}
 ...
 * 获取请假类型文本
 */
const getLeaveTypeText = (typeKey) => {
  const type = leaveTypes.value.find(t => t.key === typeKey)
...
onMounted(async () => {
  // 获取请假类型列表
  await leaveRecordsStore.fetchLeaveTypes()
  fetchLeaveRecords()
})
</script>
